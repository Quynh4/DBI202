...
(
	...
	--MajorID char(2) REFERENCES MajorV2(MajorID) -- đây là viết tắt
	MajorID char(2) FOREIGN KEY REFERENCES MajorV2(MajorID) --một cách viết khác nhưng ý nghĩa vẫn như thế
